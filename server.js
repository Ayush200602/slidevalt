...
async function seedDatabase() {
  ...
  await Presentation.insertMany([
    ...
    { title:'UI/UX Design Principles & Figma Workflow', author:'Dr. Sneha Patel', institution:'NID Ahmedabad', cat:'design', desc:'Foundational design principles, Figma prototyping workflow, accessibility standards, and real-world case studies from top products.', tags:['Figma','UX Research','Prototyping','Accessibility'], slideCount:41, downloads:289, views:732, likes:75 },
